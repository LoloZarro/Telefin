    ...
    const TelefinConfig = {
        ...
        notificationType: {
            values: {
                ...
                "ItemDeleted": ["Item Deleted", "Movies", "Series", "Seasons", "Episodes (recommended: disabled)", "Albums", "Songs", "Books"],
                ...
                "SessionStart": "Session Start (recommended: disabled)",
                "PendingRestart": "Pending Restart",
                "TaskCompleted": "Task Completed (recommended: disabled)",

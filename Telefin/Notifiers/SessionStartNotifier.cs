...
public class SessionStartNotifier : IEventConsumer<SessionStartedEventArgs>
{
    ...
    public SessionStartNotifier(NotificationDispatcher notificationFilter)
    {
    ...
    public async Task OnEvent(SessionStartedEventArgs eventArgs)
    {
        ...
        await _notificationDispatcher.DispatchNotificationsAsync(NotificationType.SessionStart, eventArgs, userId).ConfigureAwait(false);
    }
